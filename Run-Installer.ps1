...
# Настройка правил Брандмауэра Windows для SS и OpenSSH...
	...
	if( $? ){ CMD_Ok } else { CMD_Err }
	Copy-Item "PSPelengLibs-Help.xml" "$env:WINDIR\System32\WindowsPowerShell\v1.0\Modules\PSPelengLibs\" -Force *>$null
...
# Завершение -> Перезагрузка
	...
	$Branch = "Microsoft.PowerShell.Core\Registry::HKU\$strSID\SOFTWARE\Microsoft\Windows\CurrentVersion\Search"
